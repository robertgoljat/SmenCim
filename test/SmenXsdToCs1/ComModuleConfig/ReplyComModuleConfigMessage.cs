namespace CIM.ReplyComModuleConfig
{
    using System;
    ...
    /// <remarks/>
    [DataContract()]
    public class ComModuleConfigResponseMessageType
    {
    ...
    [DataContract()]
    public class CreatedComModuleConfigEvent
    {
        private ComModuleConfigEventMessageType comModuleConfigEventMessage;

        [DataMember()]
        public ComModuleConfigEventMessageType ComModuleConfigEventMessage
        {
            get
            {
                return this.comModuleConfigEventMessage;
            }
            set
            {
                this.comModuleConfigEventMessage = value;
            }
        }
    }
    
    [DataContract()]
    public class ChangedComModuleConfigEvent
    {
        private ComModuleConfigEventMessageType comModuleConfigEventMessage;
    ...
    [DataContract()]
    public class CanceledComModuleConfigEvent
    {
        private ComModuleConfigEventMessageType comModuleConfigEventMessage;
    ...
    [DataContract()]
    public class ClosedComModuleConfigEvent
    {
        private ComModuleConfigEventMessageType comModuleConfigEventMessage;
    ...
    [DataContract()]
    public class DeletedComModuleConfigEvent
    {
        private ComModuleConfigEventMessageType comModuleConfigEventMessage;
    ...
    [DataContract()]
    public class ComModuleConfigResponse
    {
    ...
    public class ReplyComModuleConfigService : IReplyComModuleConfigService
    {
        public Func<CreatedComModuleConfigEvent, ComModuleConfigResponse> CreatedHandler { get; set; }
        public Func<ChangedComModuleConfigEvent, ComModuleConfigResponse> ChangedHandler { get; set; }
        public Func<CanceledComModuleConfigEvent, ComModuleConfigResponse> CanceledHandler { get; set; }
        public Func<ClosedComModuleConfigEvent, ComModuleConfigResponse> ClosedHandler { get; set; }
        public Func<DeletedComModuleConfigEvent, ComModuleConfigResponse> DeletedHandler { get; set; }

        public ComModuleConfigResponse CreatedComModuleConfig(CreatedComModuleConfigEvent request)
        {
            try
            {
                request.ComModuleConfigEventMessage.IsHeaderOk(false, false);
                
                return this.CreatedHandler(request);
            }
            catch (Exception e1)
            {
                return new ComModuleConfigResponse()
                {
                    ComModuleConfigResponseMessage = new ComModuleConfigResponseMessageType()
                    {
                        Header = new HeaderType()
                        {
                            Verb = request.ComModuleConfigEventMessage.Header.Verb,
                            Noun = request.ComModuleConfigEventMessage.Header.Noun
                        },
                        Reply = new ReplyType()
                        {
        ...
        public ComModuleConfigResponse ChangedComModuleConfig(ChangedComModuleConfigEvent request)
        {
            try
            {
                request.ComModuleConfigEventMessage.IsHeaderOk(false, false);

                return this.ChangedHandler(request);
            }
            catch (Exception e1)
            {
                return new ComModuleConfigResponse()
        ...
        public ComModuleConfigResponse CanceledComModuleConfig(CanceledComModuleConfigEvent request)
        {
            try
            {
                request.ComModuleConfigEventMessage.IsHeaderOk(false, false);

                return this.CanceledHandler(request);
            }
            catch (Exception e1)
            {
                return new ComModuleConfigResponse()
        ...
        public ComModuleConfigResponse ClosedComModuleConfig(ClosedComModuleConfigEvent request)
        {
            try
            {
                request.ComModuleConfigEventMessage.IsHeaderOk(false, false);

                return this.ClosedHandler(request);
            }
            catch (Exception e1)
            {
                return new ComModuleConfigResponse()
        ...
        public ComModuleConfigResponse DeletedComModuleConfig(DeletedComModuleConfigEvent request)
        {
            try
            {
                request.ComModuleConfigEventMessage.IsHeaderOk(false, false);

                return this.DeletedHandler(request);
            }
            catch (Exception e1)
            {
                return new ComModuleConfigResponse()
    ...
    [ServiceContract]
    public interface IReplyComModuleConfigService
    {
        [OperationContract]
        ComModuleConfigResponse CreatedComModuleConfig(CreatedComModuleConfigEvent request);
        [OperationContract]
        ComModuleConfigResponse ChangedComModuleConfig(ChangedComModuleConfigEvent request);
        [OperationContract]
        ComModuleConfigResponse CanceledComModuleConfig(CanceledComModuleConfigEvent request);
        [OperationContract]
        ComModuleConfigResponse ClosedComModuleConfig(ClosedComModuleConfigEvent request);
        [OperationContract]
        ComModuleConfigResponse DeletedComModuleConfig(DeletedComModuleConfigEvent request);
    }
}
