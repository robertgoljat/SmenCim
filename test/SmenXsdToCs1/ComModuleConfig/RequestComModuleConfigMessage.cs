namespace CIM.RequestComModuleConfig {
    using System;
    ...
    /// <remarks/>
    [DataContract()]
    public class ComModuleConfigRequestMessageType : IRequestMessageType<ComModuleConfigPayloadType>
    {
    ...
    /// <remarks/>
    [DataContract()]
    public class ComModuleConfigEventMessageType : IEventMessageType<ComModuleConfigPayloadType>
    {
    ...
    [DataContract()]
    public class CreateComModuleConfigRequest
    {
        
        private ComModuleConfigRequestMessageType comModuleConfigRequestMessage;
        
        [DataMember()]
        public ComModuleConfigRequestMessageType ComModuleConfigRequestMessage {
            get {
                return this.comModuleConfigRequestMessage;
            }
            set {
                this.comModuleConfigRequestMessage = value;
            }
        }
    }
    
    [DataContract()]
    public class CreateComModuleConfigResponse
    {
    ...
    [DataContract()]
    public class ChangeComModuleConfigRequest
    {
    ...
    [DataContract()]
    public class ChangeComModuleConfigResponse
    {
    ...
    [DataContract()]
    public class CancelComModuleConfigRequest
    {
    ...
    [DataContract()]
    public class CancelComModuleConfigResponse
    {
    ...
    [DataContract()]
    public class CloseComModuleConfigRequest
    {
    ...
    [DataContract()]
    public class CloseComModuleConfigResponse
    {
    ...
    [DataContract()]
    public class DeleteComModuleConfigRequest
    {
    ...
    [DataContract()]
    public class DeleteComModuleConfigResponse
    {
    ...
    public class RequestComModuleConfigService : IRequestComModuleConfigService
    {
        public Func<CreateComModuleConfigRequest, CreateComModuleConfigResponse> CreateHandler { get; set; }
        public Func<ChangeComModuleConfigRequest, ChangeComModuleConfigResponse> ChangeHandler { get; set; }
        public Func<CancelComModuleConfigRequest, CancelComModuleConfigResponse> CancelHandler { get; set; }
        public Func<CloseComModuleConfigRequest, CloseComModuleConfigResponse> CloseHandler { get; set; }
        public Func<DeleteComModuleConfigRequest, DeleteComModuleConfigResponse> DeleteHandler { get; set; }

        public virtual CreateComModuleConfigResponse CreateComModuleConfig(CreateComModuleConfigRequest request)
        {
            try
            {
                request.ComModuleConfigRequestMessage.IsHeaderOk(false, false, false);
                request.ComModuleConfigRequestMessage.IsRequestOk(true, true, true, true);

                return this.CreateHandler(request);
            }
            catch (Exception e1)
            {
                return new CreateComModuleConfigResponse()
                {
                    ComModuleConfigResponseMessage = new ComModuleConfigResponseMessageType()
                    {
                        Header = new HeaderType()
                        {
                            Verb = request.ComModuleConfigRequestMessage.Header.Verb,
                            Noun = request.ComModuleConfigRequestMessage.Header.Noun
                        },
                        Reply = new ReplyType()
                        {
        ...
        public virtual ChangeComModuleConfigResponse ChangeComModuleConfig(ChangeComModuleConfigRequest request)
        {
            try
            {
                request.ComModuleConfigRequestMessage.IsHeaderOk(false, false, false);
                ...
                return this.ChangeHandler(request);
            }
            catch (Exception e1)
            {
                return new ChangeComModuleConfigResponse()
                {
                    ComModuleConfigResponseMessage = new ComModuleConfigResponseMessageType()
                    {
                        Header = new HeaderType()
        ...
        public virtual CancelComModuleConfigResponse CancelComModuleConfig(CancelComModuleConfigRequest request)
        {
            try
            {
                request.ComModuleConfigRequestMessage.IsHeaderOk(false, false, false);
            ...
            {
                return new CancelComModuleConfigResponse()
                {
                    ComModuleConfigResponseMessage = new ComModuleConfigResponseMessageType()
                    {
                        Header = new HeaderType()
        ...
        public virtual CloseComModuleConfigResponse CloseComModuleConfig(CloseComModuleConfigRequest request)
        {
            try
            {
                request.ComModuleConfigRequestMessage.IsHeaderOk(false, false, false);
                ...
                return this.CloseHandler(request);
            }
            catch (Exception e1)
            {
                return new CloseComModuleConfigResponse()
                {
                    ComModuleConfigResponseMessage = new ComModuleConfigResponseMessageType()
                    {
                        Header = new HeaderType()
        ...
        public virtual DeleteComModuleConfigResponse DeleteComModuleConfig(DeleteComModuleConfigRequest request)
        {
            try
            {
                request.ComModuleConfigRequestMessage.IsHeaderOk(false, false, false);
            ...
            {
                return new DeleteComModuleConfigResponse()
                {
                    ComModuleConfigResponseMessage = new ComModuleConfigResponseMessageType()
                    {
                        Header = new HeaderType()
    ...
    [ServiceContract]
    public interface IRequestComModuleConfigService
    {
        [OperationContract]
        CreateComModuleConfigResponse CreateComModuleConfig(CreateComModuleConfigRequest request);
        [OperationContract]
        ChangeComModuleConfigResponse ChangeComModuleConfig(ChangeComModuleConfigRequest request);
        [OperationContract]
        CancelComModuleConfigResponse CancelComModuleConfig(CancelComModuleConfigRequest request);
        [OperationContract]
        CloseComModuleConfigResponse CloseComModuleConfig(CloseComModuleConfigRequest request);
        [OperationContract]
        DeleteComModuleConfigResponse DeleteComModuleConfig(DeleteComModuleConfigRequest request);
    }
}
